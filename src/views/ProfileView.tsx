...
export const ProfileView: React.FC<ProfileViewProps> = ({ onNavigate }) => {
  ...
  const menuItems = [
    ...
    { icon: MapPin, label: 'Dispatch', value: 'Addresses' },
    { icon: CreditCard, label: 'Vault Security', value: 'Payments' },
    { icon: Settings, label: 'Atelier Settings', value: 'Privacy' },
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center mb-12">
        <div className="w-32 h-32 rounded-[2.5rem] overflow-hidden border-4 border-luxury-gold/30 p-1 mb-6 shadow-2xl">
          <img
            src={`https://api.dicebear.com/7.x/initials/svg?seed=${user?.email}&backgroundColor=d4af37&textColor=ffffff`}
